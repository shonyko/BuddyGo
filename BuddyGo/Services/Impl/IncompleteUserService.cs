...
namespace BuddyGo.Services.Impl {
    public class IncompleteUserService : BaseService<IncompleteUser, IncompleteUserDTO, IncompleteUserCreateDTO, IncompleteUserUpdateDTO>, IIncompleteUserService {
